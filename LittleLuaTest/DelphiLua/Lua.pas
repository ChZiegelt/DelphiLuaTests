...
function LuaWrapperReader(L: lua_State; ud: Pointer; var sz: Lua.API.size_t): PAnsiChar; cdecl;
var
  script: PLuaScript;

begin
  script := ud;
  //Result := script^.GetNextChunk(NativeUInt(sz));
